...
=item L<http://judy.sourceforge.net/doc/10minutes.htm>

A 10 minute technical description

=item L<http://judy.sourceforge.net/doc/shop_interm.pdf>
...
=head2 libJudy C LIBRARY

The Perl CPAN module wraps the C library available at
L<http://judy.sourceforge.net/>. Download and install this prior to
attempting to install Judy. At the time of this writing,
Judy-1.0.4 happens to be the latest but I don't have any particular
reason to prefer one version over another. If you have a newer
version, give it a try.

Fetch Judy from L<http://judy.sourceforge.net>
...
=head2 Judy::* PERL LIBRARY

Fetch Judy from CPAN, L<http://search.cpan.org>.
...
Judy, the perl wrapper was written by Joshua ben Jore
